...
public interface ApiService {
    ...
    @GET("data/cover.jsp")
    Call<List<blBean>> TU(@Query("gid") String git, @Query("type") String type, @Query("cs") String cs, @Query("ps") String ps, @Query("utoekn") String utoken, @Query("p") int page);
//    http://app.beautylegcn.com/data/detail.jsp?ps=1000&t=1462513161268&hd=4&cs=99006c75440c7f66ec39c69a122bb346&id=8777&sessionid=7ee945c8e3224e6ec8ca0f2bfecf44bd9581913f452118e06c252614128394809e52b3187a38f561
    @GET("data/detail.jsp")
    Call<List<DetailImageBean>> Detail(@Query("ps") int ps, @Query("t") long t, @Query("hd") int hd, @Query("cs") String cs, @Query("id") int id, @Query("sessionid") String sessionid);
